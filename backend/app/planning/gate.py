...
def check_annual_plan_gate(
    ...
    """
    Issue #82: Weak management flow - plans are generated atomically on assessment
    submit. This gate is kept for backward compatibility but always returns
    eligible if any assessment exists.
    """
